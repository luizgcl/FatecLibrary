...
namespace FatecLibrary.IdentityServer.SeedDataBase.Entities
{
    public class DatabaseIdentityServerInitializer : IDatabaseInitializer
    {
        ...
        public void InitializeSeedUsers()
        {
            ...
            if (_userManager.FindByEmailAsync("luizleme@gmail.com").Result is null)
            {
                // define os dados dos usuário admin
                ApplicationUser admin = new ApplicationUser()
                {
                    UserName = "luizleme",
                    NormalizedUserName = "LUIZLEME",
                    Email = "luizleme@gmail.com",
                    NormalizedEmail = "LUIZLEME@GMAIL.COM",
                    EmailConfirmed = true,
                    LockoutEnabled = false,
                    PhoneNumber = "+55 (17) 99111-1111",
                    FirstName = "Luiz",
                    LastName = "Leme",
                ...
                IdentityResult resultAdmin = 
                    _userManager.CreateAsync(admin, "luiZ@0").Result; 
            ...
            if (_userManager.FindByEmailAsync("cliente@gmail.com").Result is null)
            {
